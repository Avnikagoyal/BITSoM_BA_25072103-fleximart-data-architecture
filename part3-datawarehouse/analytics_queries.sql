...
-- Business Scenario: CEO wants yearly → quarterly → monthly sales view for 2024
...
-- Business Scenario: Identify top-performing products with revenue contribution
...
-- Business Scenario: Segment customers by total spending
